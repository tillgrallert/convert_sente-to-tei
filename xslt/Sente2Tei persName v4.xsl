...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- this stylesheet exports tagged names of persons from a Sente XML file. It produces a TEI XML file containig a listPers with all contributors and recipients in a Sente XML as unique values -->
    <!-- This stylesheet is to be run on a Sente XML. It produces and saves a TEI XML master file of unique persNames (checked against a master file) through modes m2 and m3 -->
    <!-- modes:
    ...
    - pg mNym1: produces the nym file from the Sente XML. When the stylesheet is run on a TEI XML, mNym1 produces a nym file of unique values for surnames and forenames.
