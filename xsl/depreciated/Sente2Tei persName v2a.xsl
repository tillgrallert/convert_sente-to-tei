...
<xsl:stylesheet  
    ...
    <!-- plans: currently the forename still contains a string of multiple names. These should be split into multiple forename tags -->
    
    <!-- v2a: 
        - pgMode introduced for selecting the modes mRep or mNym1
    ...
    <!-- this parameter toggles between the modes mNym and mNym1 -->
